...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'tj_ustavinfo'); ?>
		<?php echo $form->textArea($model,'tj_ustavinfo',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'tj_ustavinfo'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'ru_ustavinfo'); ?>
		<?php echo $form->textArea($model,'ru_ustavinfo',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'ru_ustavinfo'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'en_ustavinfo'); ?>
		<?php echo $form->textArea($model,'en_ustavinfo',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'en_ustavinfo'); ?>
	</div>
