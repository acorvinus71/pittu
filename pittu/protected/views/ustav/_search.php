...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_ustav'); ?>
		<?php echo $form->textField($model,'id_ustav'); ?>
	</div>
