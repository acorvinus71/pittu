...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'tj_infokaf'); ?>
		<?php echo $form->textArea($model,'tj_infokaf',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'tj_infokaf'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'ru_infokaf'); ?>
		<?php echo $form->textArea($model,'ru_infokaf',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'ru_infokaf'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'en_infokaf'); ?>
		<?php echo $form->textArea($model,'en_infokaf',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'en_infokaf'); ?>
	</div>
