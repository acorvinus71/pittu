...
<?php $this->pageTitle=Yii::app()->name . 'Барномарезӣ ва низомҳои иттилоотӣ';
$this->breadcrumbs=array(
	Yii::t('translate','Барномарезӣ ва низомҳои иттилоотӣ'),
);
?>
<?php
require_once dirname(__FILE__) . '/../site/conn.php';
$sql=mysqli_query($link,"select * from kafedra where id_kafedra=5");
