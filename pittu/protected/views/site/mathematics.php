...
<?php $this->pageTitle=Yii::app()->name . 'Математикаи олӣ ва физика';
$this->breadcrumbs=array(
	Yii::t('translate','Математикаи олӣ ва физика'),
);
?>
<?php
require_once dirname(__FILE__) . '/../site/conn.php';
$sql=mysqli_query($link,"select * from kafedra where id_kafedra=3");
