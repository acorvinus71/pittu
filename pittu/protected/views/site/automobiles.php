...
<?php $this->pageTitle=Yii::app()->name . 'Автомобилҳо ва Идоракунӣ дар Нақлиёт';
$this->breadcrumbs=array(
	Yii::t('translate','Автомобилҳо ва Идоракунӣ дар Нақлиёт'),
);
?>
<?php
require_once dirname(__FILE__) . '/../site/conn.php';
$sql=mysqli_query($link,"select * from kafedra where id_kafedra=11");
