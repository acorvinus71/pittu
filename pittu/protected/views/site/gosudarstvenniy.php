...
<?php $this->pageTitle=Yii::app()->name . 'Забони давлатӣ ва ҷомеашиносӣ';
$this->breadcrumbs=array(
	Yii::t('translate','Забони давлатӣ ва ҷомеашиносӣ'),
);
?>
<?php
require_once dirname(__FILE__) . '/../site/conn.php';
$sql=mysqli_query($link,"select * from kafedra where id_kafedra=6");
