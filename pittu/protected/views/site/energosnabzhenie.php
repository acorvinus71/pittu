...
<?php $this->pageTitle=Yii::app()->name . 'Таъминоти барқ ва автоматика';
$this->breadcrumbs=array(
	Yii::t('translate','Таъминоти барқ ва автоматика'),
);
?>
<?php
require_once dirname(__FILE__) . '/../site/conn.php';
$sql=mysqli_query($link,"select * from kafedra where id_kafedra=8");
