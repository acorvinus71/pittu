...
<?php $this->pageTitle=Yii::app()->name . 'Химия ва Технологияи маводи хӯрока';
$this->breadcrumbs=array(
	Yii::t('translate','Химия ва Технологияи маводи хӯрока'),
);
?>
<?php
require_once dirname(__FILE__) . '/../site/conn.php';
$sql=mysqli_query($link,"select * from kafedra where id_kafedra=7");
