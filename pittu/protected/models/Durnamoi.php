...
/**
 * This is the model class for table "durnamoi".
 *
 * The followings are the available columns in table 'durnamoi':
 * @property integer $id_durnamoi
 ...
 */
class Durnamoi extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Durnamoi the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_durnamoi, tj_zagalovok, ru_zagalovok, en_zagalovok, tj_info, ru_info, en_info', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_durnamoi',$this->id_durnamoi);
