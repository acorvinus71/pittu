...
/**
 * This is the model class for table "pravila".
 *
 * The followings are the available columns in table 'pravila':
 * @property integer $id_pravila
 ...
 */
class Pravila extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Pravila the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_pravila, tj_zagalovok, ru_zagalovok, en_zagalovok, tj_text, ru_text, en_text', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_pravila',$this->id_pravila);
