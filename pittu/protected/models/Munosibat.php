...
/**
 * This is the model class for table "munosibat".
 *
 * The followings are the available columns in table 'munosibat':
 * @property integer $id_munosibat
 ...
 */
class Munosibat extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Munosibat the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_munosibat, tj_zagalovok, ru_zagalovok, en_zagalovok, tj_text, ru_text, en_text', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_munosibat',$this->id_munosibat);
