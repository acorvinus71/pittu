...
/**
 * This is the model class for table "fosilavi".
 *
 * The followings are the available columns in table 'fosilavi':
 * @property integer $id_fosilavi
 ...
 */
class Fosilavi extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Fosilavi the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_fosilavi, tj_zagalovok, ru_zagalovok, en_zagalovok, tj_text, ru_text, en_text', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_fosilavi',$this->id_fosilavi);
