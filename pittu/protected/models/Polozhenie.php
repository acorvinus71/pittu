...
/**
 * This is the model class for table "polozhenie".
 *
 * The followings are the available columns in table 'polozhenie':
 * @property integer $id_polozhenie
 ...
 */
class Polozhenie extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Polozhenie the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_polozhenie, tj_zagalovok, ru_zagalovok, en_zagalovok, tj_info, ru_info, en_info', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_polozhenie',$this->id_polozhenie);
