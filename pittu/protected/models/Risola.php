...
/**
 * This is the model class for table "risola".
 *
 * The followings are the available columns in table 'risola':
 * @property integer $id_risola
 ...
 */
class Risola extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Risola the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_risola, tj_zagalovok, ru_zagalovok, en_zagalovok, tj_info, ru_info, en_info', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_risola',$this->id_risola);
